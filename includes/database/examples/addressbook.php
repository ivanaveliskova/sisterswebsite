		...
		<tr>
			<td align="center" valign="top"><br><br>
				...
				<table style="width: 550px;">
					<tr>
						<td><h2><?php echo lang('my-addressbook'); ?></h2></td>
						<td align="right">
...
?>
					...
					<tr><td colspan="<?php echo strlen($chars); ?>">
<?
