...
class Savant2_Plugin_form extends Savant2_Plugin {
	...
	*/
	...
	function label($name, $attr = null,
		$validCode = null, $validMsg = null)
	{
		$xhtml = '';
		$xhtml .= '<label name="' . htmlspecialchars($name) . '"';
		$xhtml .= $this->_attr($attr);
		$xhtml .= '>'. htmlspecialchars($name) . '</label>';
		return $this->_element($name, $xhtml, $validCode, $validMsg);
	}
